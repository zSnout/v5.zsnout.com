...
let csp = `default-src 'self'
  connect-src 'self' blob: https://chessboardjs.com/ https://fonts.googleapis.com/ https://fonts.gstatic.com/ https://cdnjs.cloudflare.com/ https://unpkg.com/ https://raw.githubusercontent.com/
